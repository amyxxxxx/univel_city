...
# side1 = int(input('Please enter the first length of the triangle : '))
# side2 = int(input('Please enter the second length of the triangle: '))
# side3 = int(input('Please enter the third length of the triangle: '))
